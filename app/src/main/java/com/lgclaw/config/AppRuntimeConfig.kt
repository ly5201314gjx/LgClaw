...
data class UiPreferencesConfig(
    ...
    val themeUserBubbleColorHex: String = "#DCEBFF",
    val themeAssistantBubbleColorHex: String = "#FFFFFF",
    val themeToolBubbleColorHex: String = "#ECF7F2",
    val themeBubbleOpacity: Float = 0.9f,
    val themeBubbleCornerRadius: Float = 20f,
    val themeBubbleBorderAlpha: Float = 0.38f,
    val themeBubbleHighlightAlpha: Float = 0.28f,
    val themeBubbleShadowAlpha: Float = 0.1f,
    val themeBubbleGlassStrength: Float = 0.46f,
