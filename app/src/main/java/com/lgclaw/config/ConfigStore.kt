...
class ConfigStore(context: Context) {
    ...
    fun getUiPreferencesConfig(): UiPreferencesConfig {
        return UiPreferencesConfig(
            ...
            themeUserBubbleColorHex = prefs.getString(KEY_UI_THEME_USER_BUBBLE_COLOR_HEX, "#DCEBFF").orEmpty().ifBlank { "#DCEBFF" },
            themeAssistantBubbleColorHex = prefs.getString(KEY_UI_THEME_ASSISTANT_BUBBLE_COLOR_HEX, "#FFFFFF").orEmpty().ifBlank { "#FFFFFF" },
            themeToolBubbleColorHex = prefs.getString(KEY_UI_THEME_TOOL_BUBBLE_COLOR_HEX, "#ECF7F2").orEmpty().ifBlank { "#ECF7F2" },
            themeBubbleOpacity = prefs.getFloat(KEY_UI_THEME_BUBBLE_OPACITY, 0.9f).coerceIn(0.28f, 1f),
            themeBubbleCornerRadius = prefs.getFloat(KEY_UI_THEME_BUBBLE_CORNER_RADIUS, 20f).coerceIn(8f, 28f),
            themeBubbleBorderAlpha = prefs.getFloat(KEY_UI_THEME_BUBBLE_BORDER_ALPHA, 0.38f).coerceIn(0f, 1f),
            themeBubbleHighlightAlpha = prefs.getFloat(KEY_UI_THEME_BUBBLE_HIGHLIGHT_ALPHA, 0.28f).coerceIn(0f, 1f),
            themeBubbleShadowAlpha = prefs.getFloat(KEY_UI_THEME_BUBBLE_SHADOW_ALPHA, 0.1f).coerceIn(0f, 0.55f),
            themeBubbleGlassStrength = prefs.getFloat(KEY_UI_THEME_BUBBLE_GLASS_STRENGTH, 0.46f).coerceIn(0f, 1f),
